defmodule Issues.TableFormatter do
  ...
  @doc """
  Takes a list of row data, where each row is 
  a Map, and a list of headers.
  Prints a table to STDOUT of the data fro each 
  row identified by each header. That is, each 
  header identifies a column, and those columns 
  are extraceded and printed from the rows.
  We calculate the width of each column to fit 
